...
<base href = "<?php echo site_url();?>">
    ...
    <link rel="stylesheet" href="assests/css/oschina2011.css" type="text/css" media="screen">
  <link rel="stylesheet" href="assests/css/thickbox.css" type="text/css" media="screen">
  <link rel="stylesheet" href="assests/css/osc-popup.css" type="text/css" media="screen">
  ...
  <script type="text/javascript" src="assests/js/thickbox.js"></script>
...
<form id="frm_reg" action="user/reg_user" onsubmit = "return false " method="POST" style="float:left; width:620px;">
...
<script src="images/getcity.js"></script><span class="nodisp">请选择您所在的地区</span></td>
    	...
    	<tr>
			...
			<span><a href="javascript:;" id = "changeImg">换另外一个图</a></span>
			</td>
    	</tr>
		<tr>
    		<th>&nbsp;</th>		
    	...
    	<tr class="buttons">
    		...
    		<input value=" 注册新用户 "  id = "reg" class="BUTTON SUBMIT" type="submit">
			</td>
    	</tr>
	</tbody></table>
</form>
